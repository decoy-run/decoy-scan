...
If you discover a security vulnerability in decoy-scan, please report it responsibly.
...
This policy covers the `decoy-scan` npm package, including the CLI (`bin/cli.mjs`) and library API (`index.mjs`).
