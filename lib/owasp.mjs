...
const OWASP_MAP = {
  ...
  "unpinned-remote-source": { id: "ASI03", name: "Supply Chain Risk", description: "Server runs code from a remote/VCS source rather than a pinned package" },
  "unpinned-dist-tag": { id: "ASI03", name: "Supply Chain Risk", description: "Server package pinned to a moving dist-tag" },
  "env-exposure": { id: "ASI03", name: "Supply Chain Risk", description: "Sensitive credentials passed to MCP server" },
  "hardcoded-secret": { id: "ASI03", name: "Supply Chain Risk", description: "Literal credential hardcoded in server config" },
  // Data exfiltration
